...
PROFILE_MIN_QUIRKINESS = float(os.getenv("PROFILE_MIN_QUIRKINESS", "0"))
PROFILE_MIN_ETHNICITY_FIT = float(os.getenv("PROFILE_MIN_ETHNICITY_FIT", "0"))
PROFILE_MIN_COMPOSITE = float(os.getenv("PROFILE_MIN_COMPOSITE", "6"))
PROFILE_WEIGHT_ATTRACTIVENESS = float(
    os.getenv("PROFILE_WEIGHT_ATTRACTIVENESS", "0.45")
)
PROFILE_WEIGHT_SLIMNESS = float(os.getenv("PROFILE_WEIGHT_SLIMNESS", "0.25"))
PROFILE_WEIGHT_QUIRKINESS = float(os.getenv("PROFILE_WEIGHT_QUIRKINESS", "0.15"))
PROFILE_WEIGHT_ETHNICITY_FIT = float(
    os.getenv("PROFILE_WEIGHT_ETHNICITY_FIT", "0.15")
)
PROFILE_IMAGE_COUNT = int(os.getenv("PROFILE_IMAGE_COUNT", "3"))
AUTOSWIPE_MAX_SWIPES = int(os.getenv("AUTOSWIPE_MAX_SWIPES", "15"))
AUTOSWIPE_PASTE_COMMENT = os.getenv("AUTOSWIPE_PASTE_COMMENT", "true").lower() in {
    "1",
    "true",
    "yes",
}
AUTOSWIPE_ETHNICITY_PREFERENCE = os.getenv("AUTOSWIPE_ETHNICITY_PREFERENCE", "")
AUTOSWIPE_PRESET = os.getenv("AUTOSWIPE_PRESET", "default")
