...
Less is more. Sound human. Sound unbothered.
...
- Prefer plain ASCII punctuation (straight quotes, hyphen/comma — no em-dashes).
...
def normalize_reply(text: str) -> str:
    """Make model output paste-safe and consistent."""
    if not text:
        return ""
